 ...
 * @lo: This value of the smallest node visited thus far.
 * @hi: This value of the largest node visited this far.
 *
 * Return: If this tree is a valid AVL tree, 1, otherwise, 0.
 */
int is_avl_helper(const binary_tree_t *tree, int lo, int hi)
{
